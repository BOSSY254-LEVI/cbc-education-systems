...
export default function ContactPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#fafafa] dark:bg-[#020817] pt-24 pb-12">
        <Header />
      ...
      <section className="container mx-auto px-6 text-center mb-16">
        ...
        >
          ...
          <span className="text-xs font-bold text-blue-700 dark:text-blue-300 uppercase tracking-widest">Connect with EduStack</span>
        </motion.div>
        ...
        <motion.h1 
          ...
          className="text-4xl md:text-6xl font-extrabold text-[#001f3f] dark:text-white mb-6"
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              ...
              <button
                ...
                className="w-full py-5 bg-gradient-to-r from-[#0047AB] to-[#0056D6] hover:from-[#003580] hover:to-[#0047AB] text-white font-bold text-lg rounded-2xl shadow-lg shadow-blue-600/20 flex items-center justify-center gap-3 transition-all duration-300 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed group relative overflow-hidden"
              >
          ...
          >
            ...
            <div className="p-8 rounded-[32px] bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-900 border border-blue-100 dark:border-slate-700">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">Why EduStack?</h3>
              </div>
        ...
        >
          <div className="text-center mb-12">
            ...
            >
              ...
              <span className="text-xs font-bold text-blue-700 dark:text-blue-300 uppercase tracking-widest">Platform Features</span>
            </motion.div>
        ...
        >
          <div className="text-center mb-12">
            ...
            >
              ...
              <span className="text-xs font-bold text-blue-700 dark:text-blue-300 uppercase tracking-widest">Latest Updates</span>
            </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {[
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-slate-900 dark:text-white font-bold text-lg leading-tight group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                    {news.title}
                  </h3>
            ...
            {[
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-5xl font-extrabold mb-2">{stat.metric}</div>
      ...
      {/* Footer */}
      <footer className="mt-24 py-12 bg-[#001f3f] text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-0 left-1/3 w-96 h-96 bg-blue-400 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-1/3 w-96 h-96 bg-indigo-400 rounded-full blur-3xl"></div>
        </div>
        <div className="container mx-auto px-6 text-center relative z-10">
          <p className="text-blue-200 mb-2">© 2026 EduStack Kenya. All rights reserved.</p>
          <p className="text-sm text-blue-300">Empowering education through technology</p>
        </div>
      </footer>
