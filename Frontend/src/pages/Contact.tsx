...
export default function ContactPage() {
  ...
  const [status, setStatus] = useState(null); // added for success/error feedback
  ...
  const handleSubmit = async (e) => {
    ...
    // Optional - makes the email nicer
    ...
    try {
      ...
      if (json.success) {
        setStatus({ type: "success", message: "Your CBC inquiry has been received. Our curriculum experts will reach out shortly." });
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              ...
              {/* ─────────────────────────────────────────────── */}
              {/*     Web3Forms hidden fields – added here        */}
              {/* ─────────────────────────────────────────────── */}
              <input 
                type="hidden" 
                name="access_key" 
