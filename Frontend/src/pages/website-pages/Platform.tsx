                ...
                >
                  <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-xl shadow-xl p-2 border-4 border-slate-600">
                    <div className="bg-white rounded-lg overflow-hidden">
                      <img src="https://images.unsplash.com/photo-1501504905252-473c47e087f8?w=400&h=600&fit=crop" alt="Tablet View" className="w-full h-auto" />
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-xl p-2 border-4 border-slate-700">
                    <div className="bg-white rounded-xl overflow-hidden">
                      <img src="https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=300&h=600&fit=crop" alt="Mobile View" className="w-full h-auto" />
                    </div>
